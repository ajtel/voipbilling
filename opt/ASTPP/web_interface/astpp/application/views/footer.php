  ...
  <?php
    ...
    if($this->session->userdata['logintype'] == 2 || $this->session->userdata['logintype'] == -1 || $this->session->userdata['logintype'] == 1 || $this->session->userdata['logintype'] == 0 ){
     ...
     if(isset($user_footer) && $user_footer != '') {  
      if ($user_footer == 'AJTEL Comunicaciones &reg S de RL de CV. All Rights Reserved.'){
        $user_footer = '';
         } ?>
       <div  class="pull-left col-3 text-left">
       <!--  <a href="https://ajtel.net" target="_blank">
        <span class="text-warning">
            <strong><?=gettext($user_footer); ?></strong>
          </span>
      </a><br> -->
     <strong> <span class="text-warning"><?php echo gettext('VoIP Solution 
      Powered by<br> AJTEL Comunicaciones &reg S de RL de CV.<br>')?> </span></strong>
      </div>
      <?php } ?>
      <!-- // end ASTPPENT-3818 -->

		<div class="col-md-4 py-8 text-md-center">
  	   		 <div class="social-media">

  	   		  <?php echo gettext('Follow us on:')?> </i></label>
  	   		 <a target="_blank" href="https://www.facebook.com/ajtel/" title="Facebook"> <i class="facebook fa fa-facebook"></i></a>
            <a target="_blank" href="https://gh.linkedin.com/company/ajtel-communications-network-group-llc" title="Linkedin"> <i class="linkin fa fa-linkedin"></i></a>
            <a target="_blank" href="https://x.com/ajtel" title="Twitter"> <i class="twitter fa fa-twitter "></i></a>
            <a target="_blank" href="https://wa.me/525512055050" title="Whatsapp"> <i class="fa fa-whatsapp" style="color:green"></i></a><br>
            <a target="_blank" href="https://tawk.to/chat/6488fbea94cf5d49dc5d86af/1h2rhg38m"><i class="fa fa-comment" style="color:blue"></i><b>CHAT NOW</b></a>
    ...
    <?} else {  ?>
      <div class="col-md-5 py-2 px-2 text-md-left text-light">Copyright @ <?php echo date("Y"); ?> <a class="text-warning" href="http://www.ajtel.net" target="_blank"> <?php echo gettext("AJTEL Comunicaciones S de RL de CV.")?></a>. <?php echo gettext("All Rights Reserved.")?>
	...
	<? } } else{ ?>
			...
			<a href="https://ajtel.net/" target="_blank">
				<span class="text-warning">
					<strong><?php echo gettext("AJTEL Comunicaciones &reg S de RL de CV.")?></strong>
				</span>
			</a>
	    </div>
		...
		<div class="col-md-3 py-2 text-md-center">
            ...
            <a target="_blank" href="https://gh.linkedin.com/company/ajtel-communications-network-group-llc" title="Linkedin"> <i class="linkin fa fa-linkedin"></i></a>
            <a target="_blank" href="https://x.com/ajtel" title="Twitter"> <i class="twitter fa fa-twitter "></i></a>
             <a target="_blank" href="https://wa.me/525585265000" title="Whatsapp"> <i class="fa fa-whatsapp" style=color:green"></i></a> 
		<a target="_blank" href="https://tawk.to/chat/6488fbea94cf5d49dc5d86af/1h2rhg38m"><i class="fa fa-comment" style="color:blue"></i><b>CHAT NOW</b></a>
...
<div class="col-md-12 float-right pt-4 pr-0 text-light text-md-right version_size"><?php echo gettext("Version")?>  <?php echo common_model::$global_config['system_config']['version'] .' '.gettext('AJTEL') ;?>
<?php
