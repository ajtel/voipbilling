  ...
  <?php
	...
	if($result->num_rows() > 0){
  	...
  	if($footer != '' && ($this->session->userdata['logintype'] == 2 || $this->session->userdata['logintype'] ==-1)){ ?>
			...
			<a href="http://www.ajtel.net" target="_blank">
		...
		<div class="col py-2">
            ...
            <a target="_blank" href="https://wa.me/525512055050" title="Whatsapp"> <i class="whatsapp fa fa-whatsapp "></i></a>
	...
	<?php	} else  if($this->session->userdata['logintype'] ==0 || $this->session->userdata['logintype'] == 1){
		...
		<?} else {  ?>
	    <div class="col-md-offset-4 col-md-4">Copyright @ <?php echo date("Y"); ?> <a style="color:#3989c0;" href="http://www.ajtel.net" target="_blank"> AJTEL Comunicaciones</a>. All Rights Reserved.
